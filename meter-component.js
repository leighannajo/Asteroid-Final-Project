(function(){
    ...
    var meterComponent = {
      ...
      <div ng-if="$ctrl.display1" id="one" class="risk one"></div>
      ...
      <div id="meter_container_trans">
      <div class="risk one"></div>
      <div class="risk one1"></div>
      <div class="risk one2"></div>
      <div class="risk two"></div>
      <div class="risk two1"></div>
      <div class="risk two2"></div>
      <div class="risk three"></div>
      <div class="risk three1"></div>
      <div class="risk three2"></div>
      <div class="risk four"></div>
      <div class="risk four1"></div>
      <div class="risk four2"></div>
      <div class="risk five"></div>
      <div class="risk five1"></div>
      <div class="risk five2"></div>
      <div class="risk six"></div>
      <div class="risk six1"></div>
      <div class="risk six2"></div>
      <div class="risk seven"></div>
      <div class="risk seven1"></div>
      <div class="risk seven2"></div>
      <div class="risk eight"></div>
      <div class="risk eight1"></div>
      <div class="risk eight2"></div>
      <div class="risk nine"></div>
      <div class="risk nine1"></div>
      <div class="risk nine2"></div>
      <div class="risk ten"></div>
      <div class="risk ten1"></div>
      <div class="risk ten2"></div>
      </div>
      </div>
      </div>
      `,
